...
For a simple example of calling c2patool from a server-based application, see the [c2patool-service-example](https://github.com/contentauth/c2patool-service-example) repository.
