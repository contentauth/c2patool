...
* Add promote.yml workflow for release-candidate promotion ([#338](https://github.com/contentauth/c2patool/pull/338)) ([#346](https://github.com/contentauth/c2patool/pull/346))
...
* Updates c2patool to use only the new Builder/Reader API (contentauth/c2pa-rs#297)

### Documented

* Update Contributing guide, misc minor edits (contentauth/c2pa-rs#296)
...
* Enlarged description of c2pa command-line behavior ([#285](https://github.com/contentauth/c2pa-rs/pull/285))
